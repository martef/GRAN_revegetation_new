...
```{r}
# Open a PNG device for the first set of plots
png("chain_convergence_part1.png", width = 800, height = 600)

# Capture the plots generated by `plot()`
plots <- plot(mod3)

# Arrange the first half of the plots
grid.arrange(grobs = plots[1:2])  # Assuming 4 plots in total, split into 2 parts

# Close the device
dev.off()

# Open a PNG device for the second set of plots
png("chain_convergence_part2.png", width = 800, height = 600)

# Arrange the second half of the plots
grid.arrange(grobs = plots[3:4])  # The remaining plots
